...
//var_dump($response);
echo "URL: <a target='_blank' href='" . $response -> url . "'>Output File</a><br/><br/>"; 
echo "Page Count: " . $response -> pageCount . "<br/><br/>"; 
echo "Error: " . $response -> error . "<br/><br/>"; 
echo "Status: " . $response -> status . "<br/><br/>"; 
echo "Name: " . $response -> name . "<br/><br/>"; 
