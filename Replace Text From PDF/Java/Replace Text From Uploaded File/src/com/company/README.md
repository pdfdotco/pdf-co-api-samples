...
public class Main
{
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                if (uploadFile(webClient, API_KEY, uploadUrl, SourceFile))
                {
                    ...
                    replaceStringFromPdf(webClient, API_KEY, DestinationFile, Password, uploadedFileUrl);
                }
            }
            else
            {
    ...
    public static void replaceStringFromPdf(OkHttpClient webClient, String apiKey, Path destinationFile,
