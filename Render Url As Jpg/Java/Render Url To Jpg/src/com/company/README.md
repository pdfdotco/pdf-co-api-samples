...
public class Main
{
    ...
    // Input url file
	final static String InputUrl = "https://www.wikipedia.org";

    // Result file name
    final static Path ResultFile = Paths.get(".\\result.jpg");
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        // Prepare URL for `Url to Jpg` API call
        String query = "https://api.pdf.co/v1/url/convert/to/jpg";
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                System.out.printf("Generated output saved to \"%s\" file.", ResultFile.toString());
            }
            else
            {
