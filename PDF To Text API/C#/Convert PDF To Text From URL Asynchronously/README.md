## How to convert PDF to text from URL asynchronously for PDF to text API in C# and PDF.co Web API
...
namespace ByteScoutWebApiExample
{
	class Program
	{
		...
		const string SourceFileUrl = "https://bytescout-com.s3.amazonaws.com/files/demo-files/cloud-api/pdf-to-text/long-processed-document.pdf";
