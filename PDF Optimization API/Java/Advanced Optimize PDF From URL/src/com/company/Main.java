...
public class Main
{
    ...
    final static String ProfileSettings = "{ 'ImageOptimizationFormat': 'JPEG', 'JPEGQuality': 25, 'ResampleImages': true, 'ResamplingResolution': 120, 'GrayscaleImages': false }";
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        // Create JSON payload
		String jsonPayload = String.format("{\"name\": \"%s\", \"password\": \"%s\", \"url\": \"%s\", \"profiles\": \"%s\"}",
