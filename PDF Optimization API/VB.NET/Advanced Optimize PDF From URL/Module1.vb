...
Module Module1
	...
	const ProfileSettings as string = "{ 'ImageOptimizationFormat': 'JPEG', 'JPEGQuality': 25, 'ResampleImages': true, 'ResamplingResolution': 120, 'GrayscaleImages': false }"
	...
	Sub Main()
		...
		parameters.Add("profiles", ProfileSettings)
