## How to convert excel to PDF in jquery async API for excel to PDF API in JavaScript with PDF.co Web API

### Learn how to convert excel to PDF in jquery async API to have excel to PDF API in JavaScript

These source code samples are listed and grouped by their programming language and functions they use. Excel to PDF API in JavaScript can be implemented with PDF.co Web API. PDF.co Web API is the flexible Web API that includes full set of functions from e-signature requests to data extraction, OCR, images recognition, pdf splitting and pdf splitting. Can also generate barcodes and read barcodes from images, scans and pdf.
