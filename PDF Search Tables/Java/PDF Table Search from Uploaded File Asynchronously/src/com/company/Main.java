...
public class Main
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                {
                    // 3. SEARCH TABLE FROM UPLOADED PDF FILE

                    searchTableFromPDF(webClient, uploadedFileUrl);
                }
            }
            else
            {
    ...
    public static void searchTableFromPDF(OkHttpClient webClient, String uploadedFileUrl) throws IOException {
        ...
        // Create JSON payload
		String jsonPayload = String.format("{\"password\": \"%s\", \"pages\": \"%s\", \"url\": \"%s\", \"async\": \"%s\"}",
                Password,
                Pages,
                uploadedFileUrl,
                Async);
