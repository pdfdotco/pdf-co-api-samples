## How to PDF create fillable PDF forms for fillable PDF forms in C# and PDF.co Web API What is PDF.co Web API? It is the Web API with a set of tools for documents manipulation, data conversion, data extraction, splitting and merging of documents. Includes image recognition, built-in OCR, barcode generation and barcode decoders to decode bar codes from scans, pictures and pdf.
...
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "FillablePDFForms", "FillablePDFForms.csproj", "{1E1C2C34-017E-4605-AE2B-55EA3313BE51}"
EndProject
Global
