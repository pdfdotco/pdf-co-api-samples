...
public class Main
{
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                if (uploadFile(webClient, API_KEY, uploadUrl, SourceFile))
                {
                    ...
                    deleteTextFromPdf(webClient, API_KEY, DestinationFile, Password, uploadedFileUrl);
                }
            }
            else
            {
    ...
    public static void deleteTextFromPdf(OkHttpClient webClient, String apiKey, Path destinationFile,
