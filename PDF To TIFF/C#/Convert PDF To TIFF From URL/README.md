## How to convert PDF to TIFF from URL for PDF to image API in C# using PDF.co Web API

### Tutorial: how to convert PDF to TIFF from URL for PDF to image API in C#
...
This rich sample source code in C# for PDF.co Web API includes the number of functions and options you should do calling the API to implement PDF to image API. Follow the instruction and copy - paste code for C# into your project's code editor. Tutorials are available along with installed PDF.co Web API if you'd like to dive deeper into the topic and the details of the API.
...
namespace ByteScoutWebApiExample
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			string url = "https://api.pdf.co/v1/pdf/convert/to/tiff";
