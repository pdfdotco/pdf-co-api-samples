## How to convert PDF to XLSX from uploaded file for PDF to excel API in VB.NET and PDF.co Web API

### How to convert PDF to XLSX from uploaded file for PDF to excel API in VB.NET: How To Tutorial
