...
Module Module1
    ...
    Sub Main()
        ' Upload Input File
        Dim UploadedFileURL As String = UploadFileAndGetUrl(SourceFile)
    ...
    ''' </summary>
    Function UploadFileAndGetUrl(ByVal SourceFile As String) As String

        Dim uploadedFileUrl As String = ""
