...
Module Module1
    ...
    Const SourceFileUrl As String = "https://bytescout-com.s3-us-west-2.amazonaws.com/files/demo-files/cloud-api/pdf-optimize/sample.pdf"

    ' Angle in degrees. Supported values are 90, 180, 270.
    Const Angle As Integer = 90

    ' Comma-separated list of page indices (Or ranges) to process. Example '0,3-5,7-'. For ALL pages just leave this param empty
    Const Pages As String = "0-2,4"
	...
	Sub Main()
        ...
        Dim url As String = "https://api.pdf.co/v1/pdf/edit/rotate"
